...
it("Si hacemos aHackerSpeak('soy un hacker') debería retornar '50y un h4ck3r'", function() {
let resultado = aHackerSpeak('soy un hacker')
assert.equal(resultado, '50y un h4ck3r',`aHackerSpeak('soy un hacker') debería retornar '50y un h4ck3r' pero fue ${resultado}`);
})
